...
for (i in 1:30) {
  ...
  cat("Model z opóźnieniem", i, "dni i wskaźnikami technicznymi:\n")
...
# Najlepszy model ma opóźnienie 30 dni z dokładnością 0.6576402 na zbiorze treningowym.
...
# Najlepszy model na zbiorze testowym ma opóźnienie 19 dni z dokładnością 0.5307692 