...
# Najlepszy model ma opóźnienie 29 dni z dokładnością 0.6615087 na zbiorze treningowym.
...
# Najlepszy model na zbiorze testowym ma opóźnienie 21 dni z dokładnością 0.5384615